		...
		$endstrike = $status_id == 4 || $status_id == 7 || $status_id == 15 ? '</strike>' : '';
	        $display = $display."<tr>"
                 ...
                 $display = $display. "<td><font color='$color'>$strike".$bill_amount."$endstrike</font></td>"
                          ...
                          . "<td><a href='BIRForm/BIRForm.php?event_id=$eventId&billing_no=".$billing_no."&bir_no=$bir_no&uid=$uid' target='_blank'><img src='images/preview.png' width='30' height='30'></a>"
